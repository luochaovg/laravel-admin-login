        ...
        <form action="{{ admin_base_path('auth/login') }}" method="post">
            ...
            <div class="row">
                <div class="form-group has-feedback {!! !$errors->has('captcha') ?: 'has-error' !!}">
                    ...
                    <input type="text" class="form-control" style="display: inline;width: 55%; margin-left: 15px; @if(config('admin.background')) background:rgba(255,255,255,0);@endif"  placeholder="{{ trans('admin.captcha') }}" name="captcha" autocomplete="off">
            ...
            @if (\Illuminate\Support\Facades\Config::get('google.is_switch'))
